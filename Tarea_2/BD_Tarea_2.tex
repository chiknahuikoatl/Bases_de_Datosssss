...
\begin{enumerate}
    ...
    \item[iv)]{Diseña diseñar  una base  de  datos  que represente los 
    conceptos revisadospara crearun diagrama E/R (no consideres el 
    Modelo E/R extendido).\\
	\includegraphics[scale= 0.5]{Pregunta4}}
\end{enumerate}
}
\item[2)]{
\begin{enumerate}
